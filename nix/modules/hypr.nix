  ...
  config = lib.mkIf config.hm.hypr.enable {
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        windowrule = [
          "float on, match:class Microsoft, match:xwayland 1"
          # "float, class:copyq"
          # "bordercolor rgba(32CD32AA) rgba(7CFC0077),floating:1"
          "float on, match:class backslash"
          "float on, match:class be.alexandervanhee.gradia"
          ...
          "float on, match:initial_title Untitled - Google Chrome"
          "monitor 1, match:class flameshot"
          "monitor 1, match:title flameshot"
          ...
          "no_anim on, match:class ulauncher"
          "no_blur on, match:class ulauncher"
          "border_size 0, match:class ulauncher"
          ...
          "workspace 5, match:class microsoft-edge"
