...
CLI.add_argument(
  "--highlight",  # name on the CLI - drop the `--` for positional/required parameters
  nargs="*",  # 0 or more values expected => creates a list
  type=str,
  default=["ActivityManager","com.ideomobile.doctorportal"],
)
CLI.add_argument(
  "--ignore",
  nargs="*",
  type=str,  # any type/callable can be used here
  default=["SpammyApp", "/system/bin/gpsd"],
